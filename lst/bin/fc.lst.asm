...
0x000440BA       MOV R8 R1              ; R8 = argc
0x000440BE       MOV R9 R2              ; R9 = argv

    ; Need at least one pathname
0x000440C2       CMP R8 2
0x000440C6       BLT usage

0x000440CE       LI R10 1               ; R10 = current argv index
0x000440D6       LI R6 0                ; R6 = return code
                           ; 0 = all successful
...
0x000440DE       CMP R10 R8
0x000440E2       BGE file_done
...
0x000440F6       LDW R1 [R2]            ; R1 = pathname
...
0x000440FA       LI R2 O_CREATE
0x00044102       BL open

0x0004410A       MOV R11 R1             ; R11 = returned fd / error

    ; fd < 0 = failure
0x0004410E       CMP R11 0
0x00044112       BLT create_failed
...
0x0004411A       MOV R1 R11
0x0004411E       BL close

0x00044126       ADD R10 R10 1
0x0004412A       B file_loop
...
0x0004415A       LI R1 newline_str_fc
0x00044162       BL puts

0x0004416A       LI R6 1                ; remember failure

0x00044172       ADD R10 R10 1
0x00044176       B file_loop
...
0x0004417E       MOV R1 R6              ; return status
...
0x000441A2       LI R1 fc_usage_str
0x000441AA       BL puts

0x000441B2       LI R1 1
0x000441BA       B file_done
