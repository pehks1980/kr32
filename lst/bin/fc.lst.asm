...
0x0004410A       LI R2 O_CREATE
0x00044112       BL open

0x0004411A       MOV R11 R1             ; R11 = returned fd / error
...
0x0004412A       MOV R1 R11
0x0004412E       BL close

0x00044136       ADD R10 R10 1
0x0004413A       B file_loop
...
0x00044142       LI R1 error_prefix
0x0004414A       BL puts

    ; argv[R10]
0x00044152       MOV R2 R10
0x00044156       SHL R2 R2 2
0x0004415A       ADD R2 R9 R2
0x0004415E       LDW R1 [R2]

0x00044162       BL puts

0x0004416A       LI R1 newline_str_fc
0x00044172       BL puts

0x0004417A       LI R6 1                ; remember failure
...
0x0004418E       MOV R1 R6              ; return status
...
0x000441B2       LI R1 fc_usage_str
0x000441BA       BL puts

0x000441C2       LI R1 1
0x000441CA       B file_done
