...
0x000440B2       MOV R8 R1            ; argc
0x000440B6       MOV R9 R2            ; argv
...
0x000440BA       CMP R8 2
0x000440BE       BLT print_usage

    ;--------------------------------------------------
    ; R2 = argv[1] = format
    ;--------------------------------------------------

0x000440C6       LDW R1 [R9 + 4]
0x000440CA       MOV R10 R1           ; R10 = save format string
...
0x000440E6       LDW R1 [R9 + 8]      ;1st-arg
0x000440EA       MOV R2 R1

0x000440EE       CMP R8 3                ; +0name +4fmt +8(1st-arg)
0x000440F2       BEQ printf_go

    ;--------------------------------------------------
    ; argv[3]
    ;--------------------------------------------------

0x000440FA       LDW R1 [R9 + 12]
0x000440FE       MOV R3 R1
0x00044102       CMP R8 4                ; name fmt arg1 arg2
0x00044106       BEQ printf_go

    ;--------------------------------------------------
    ; argv[4]
    ;--------------------------------------------------

0x0004410E       LDW R1 [R9 + 16]
0x00044112       MOV R4 R1
0x00044116       CMP R8 5                ; name fmt arg1 arg2 arg3
0x0004411A       BEQ printf_go

    ;--------------------------------------------------
    ; argv[5]               ; name fmt arg1 arg2 arg3 arg4
    ;--------------------------------------------------

0x00044122       LDW R1 [R9 + 20]
0x00044126       MOV R5 R1
0x0004412A       CMP R8 6                ;etc here we support upto printf with fmt + 4 args
0x0004412E       BEQ printf_go
...
0x00044136       MOV R1 R10
0x0004413A       BL printf

0x00044142       LI R1 0
0x0004414A       B print_done


print_usage:

0x00044152       LI R1 usage_msg
0x0004415A       BL puts
