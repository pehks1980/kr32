...
0x0004416A       POP R1
0x0004416E       LI  R2 O_RDONLY
0x00044176       BL open
0x0004417E       MOV R11 R1              ; R11 = fd

0x00044182       CMP R11 0
0x00044186       BLT open_failed

read_dir_loop:
    ; read(fd, buf, DIRENT_SIZEOF)
0x0004418E       MOV R1 R11
0x00044192       MOV R2 R12
0x00044196       LI  R3 DIRENT_SIZEOF
0x0004419E       BL read
0x000441A6       MOV R7 R1               ; R7 = bytes read (or -1 on error)

0x000441AA       CMP R7 0
0x000441AE       BEQ read_done           ; EOF
0x000441B6       CMP R7 DIRENT_SIZEOF
0x000441BA       BNE read_done           ; error or short read

    ; parse the directory entry
0x000441C2       LDB R5 [R12 + DIRENT_TYPE]   ; R5 = d_type (DT_REG or DT_DIR)

    ; print filename (null-terminated at R12 + DIRENT_NAME)
0x000441C6       ADD R1 R12 DIRENT_NAME
0x000441CA       BL puts                  ; prints the name (libc puts writes string, no newline)
...
dir_done:
    ; free buffer
0x0004426A       LI  R2 256
0x00044272       ADD SP SP R2
