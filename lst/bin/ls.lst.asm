...
0x00043C1A       LI  R3 256
0x00043C22       SUB SP SP R3
0x00043C26       MOV R12 SP              ; R12 = buffer pointer
...
0x00043CC6       POP R1
0x00043CCA       LI  R2 O_RDONLY
0x00043CD2       BL open
0x00043CDA       MOV R11 R1              ; R11 = fd

0x00043CDE       CMP R11 0
0x00043CE2       BLT open_failed

read_dir_loop:
    ; read(fd, buf, DIRENT_SIZEOF)
0x00043CEA       MOV R1 R11
0x00043CEE       MOV R2 R12
0x00043CF2       LI  R3 DIRENT_SIZEOF
0x00043CFA       BL read
0x00043D02       MOV R7 R1               ; R7 = bytes read (or -1 on error)

0x00043D06       CMP R7 0
0x00043D0A       BEQ read_done           ; EOF
0x00043D12       CMP R7 DIRENT_SIZEOF
0x00043D16       BNE read_done           ; error or short read

    ; parse the directory entry
0x00043D1E       LDB R5 [R12 + DIRENT_TYPE]   ; R5 = d_type (DT_REG or DT_DIR)

    ; print filename (null-terminated at R12 + DIRENT_NAME)
0x00043D22       ADD R1 R12 DIRENT_NAME
0x00043D26       BL puts                  ; prints the name (libc puts writes string, no newline)
...
dir_done:
    ; free buffer
0x00043DC6       LI  R2 256
0x00043DCE       ADD SP SP R2
