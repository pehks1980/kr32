...
0x000440CE       LI  R3 DIRENT_SIZEOF
0x000440D6       SUB SP SP R3
0x000440DA       MOV R12 SP              ; R12 = pointer to struct dirent buffer
...
0x00044172   CALL puts

    ; open directory using opendir wrapper
0x0004417A       POP R1                  ; path
0x0004417E   CALL opendir

0x00044186       MOV R11 R1              ; R11 = DIR* handle

0x0004418A       CMP R11 0
0x0004418E       BEQ open_failed         ; opendir returns 0 on error

read_dir_loop:
    ; Read next directory entry
0x00044196       MOV R1 R11              ; DIR*
0x0004419A       MOV R2 R12              ; pointer to dirent buffer
0x0004419E   CALL readdir
0x000441A6       CMP R1 0
0x000441AA       BEQ read_done           ; EOF
0x000441B2       LI  R2 -1
0x000441BA       CMP R1 R2
0x000441BE       BEQ read_done           ; error

    ; parse the directory entry
0x000441C6       LDW R5 [R12 + DIRENT_TYPE]   ; R5 = d_type (DT_REG or DT_DIR)

    ; print filename (null-terminated at R12 + DIRENT_NAME)
0x000441CA       ADD R1 R12 DIRENT_NAME
0x000441CE   CALL puts
